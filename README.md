...
Grupo_7/
├── dados/
│   ├── detalhe_votacao_secao_2022_SC.csv
│   ├── detalhe_votacao_secao_2022_RJ.csv
...
Disponível em:
https://cdn.tse.jus.br/estatistica/sead/odsele/detalhe_votacao_secao/detalhe_votacao_secao_2022.zip
...
Licença
Este projeto utiliza dados públicos disponibilizados pelo Tribunal Superior Eleitoral (TSE).
O uso dos dados segue as diretrizes do LEIAME oficial incluído no pacote.

Contato
Para dúvidas sobre os dados:
estatistica@tse.jus.br
